...
import { calculateCallCost, DEFAULT_SERVICE_TYPE, formatDuration } from '../utils/billingCalculator';
import { findApplicableTaxRule } from '../utils/taxEngine';
import { mockTaxRules } from './taxData';
import { DEFAULT_BILLING_COUNTRY_CODE } from './countryData';
...
export const mockDeptUsageData = [
  ...
  { department: 'Security & Compliance', calls: 4620, durationHours: 740, cost: 92600 },
...
export const mockHighUsageExtensions = [
  ...
  { extension: '3187', department: 'Security & Compliance', employee: 'Vikram Singh (Control)', calls: 764, durationHours: 39, cost: 10850 },
...
const rawCdrData = [
  ...
  { id: '2', cdrId: 'CDR-100246', ext: '3187', dept: 'Security & Compliance', caller: '3187', dest: '9811234567', type: 'Mobile', dir: 'Outgoing', date: '2026-09-08', time: '10:35:40', dur: 185, rate: 1.20, status: 'Billed' },
  ...
  { id: '11', cdrId: 'CDR-100255', ext: '3187', dept: 'Security & Compliance', caller: '3187', dest: '+97142245555', type: 'ISD', dir: 'Outgoing', date: '2026-09-08', time: '13:05:00', dur: 310, rate: 8.00, status: 'Billed' },
  ...
  { id: '18', cdrId: 'CDR-100262', ext: '3188', dept: 'Security & Compliance', caller: '3188', dest: '3187', type: 'Internal', dir: 'Internal', date: '2026-09-08', time: '15:30:25', dur: 85, rate: 0.00, status: 'Exempted' },
  ...
  { id: '25', cdrId: 'CDR-100269', ext: '3187', dept: 'Security & Compliance', caller: '3187', dest: '9910045678', type: 'Mobile', dir: 'Outgoing', date: '2026-09-08', time: '17:40:18', dur: 140, rate: 1.20, status: 'Billed' },
  ...
  { id: '33', cdrId: 'CDR-100277', ext: '3187', dept: 'Security & Compliance', caller: '3187', dest: '01123015555', type: 'Local', dir: 'Outgoing', date: '2026-09-07', time: '12:10:00', dur: 310, rate: 0.80, status: 'Billed' },
...
export const mockCDRRecords: CDRRecord[] = rawCdrData.map((item) => {
  // Tax comes from the Tax & VAT master for the call's own date, never a constant.
  const taxRule = findApplicableTaxRule(
    mockTaxRules,
    DEFAULT_BILLING_COUNTRY_CODE,
    DEFAULT_SERVICE_TYPE,
    item.date
  );
  const costInfo = calculateCallCost(item.dur, item.rate, 60, taxRule);
