        ...
        {activeTab === 'billing' && (
          <div className="space-y-6 animate-in fade-in duration-150">
            <div>
              ...
              <p className="text-xs text-slate-500 mt-0.5">
                Define VAT tax rates, monthly billing cutoff dates, and call duration pulse rounding rules.
              </p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
              {/*
                There is deliberately no global VAT rate here: tax is resolved
                per country, service type and transaction date from the Tax & VAT
                master so historical invoices stay reproducible.
              */}
              <div className="space-y-1.5">
                ...
                <div className="w-full px-3.5 py-2.5 bg-slate-50/50 border border-slate-200 rounded-xl">
                  <p className="text-[11px] text-slate-600 leading-relaxed">
                    VAT is configured per country in the Tax &amp; VAT master and resolved by
                    transaction date — there is no system-wide default rate.
                  </p>
                  <button
                    type="button"
                    onClick={() => navigate('/tax')}
                    className="mt-2 text-[11px] font-bold text-teal-700 hover:text-teal-800"
                  >
                    Open Tax &amp; VAT Master →
                  </button>
                </div>
